        ...
        <div class="max-w-4xl mx-auto">
                ...
                <div class="grid lg:grid-cols-[280px_1fr] gap-6 items-stretch">
                    <div>
                        ...
                        <div class="rounded-[20px] overflow-hidden h-[420px] bg-gray-100">
                            <img src="{{ format_image_url($user->photo) }}?t={{ time() }}" alt="Profile"
                                class="w-full h-full object-cover object-center">
                        </div>
                        @else
                        <div
                            class="h-[420px] rounded-[20px] bg-[#FFF7FB] flex flex-col items-center justify-center text-center px-8">
                            <div
                                class="w-28 h-28 rounded-full bg-pink-500 text-white flex items-center justify-center text-5xl font-bold shadow-lg">
                    ...
                    <div>
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <a href="{{ route('profile.edit') }}"
                                class="border border-pink-500 text-pink-500 hover:bg-pink-500 hover:text-white transition-all duration-200 px-5 py-2 rounded-full font-medium text-sm">
                                Edit Profile
                            </a>
                        </div>
            ...
            <div class="bg-white rounded-[24px] shadow-sm mt-3 p-4 flex items-center justify-between">
                ...
                <button onclick="togglePasswordModal()"
                    class="bg-pink-500 hover:bg-pink-600 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition">
                    Ubah
                </button>
            </div>
        </div>
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <input type="password" name="current_password"
                            class="w-full h-[45px] border border-gray-200 rounded-xl px-4 outline-none focus:border-pink-500 text-sm">
                    </div>
                    <div>
                    ...
                    <div class="pt-2 flex gap-3">
                        <button type="button" onclick="togglePasswordModal()"
                            class="flex-1 py-2.5 border border-pink-500 text-pink-500 rounded-xl font-semibold text-sm">Batal</button>
                        <button type="submit"
                            class="flex-1 py-2.5 bg-pink-500 text-white rounded-xl font-semibold text-sm">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
