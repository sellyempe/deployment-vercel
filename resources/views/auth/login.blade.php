...
<head>
    ...
    <title>Login - {{ get_setting('site_name', 'Pink Tour and Travel') }}</title>
...
<body class="min-h-screen bg-white overflow-hidden">
    ...
    <div class="min-h-screen flex w-full">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-950">
            ...
            <img src="/images/banda-neira.jpeg" alt="Banda Neira" class="absolute inset-0 w-full h-full object-cover opacity-90" style="object-position: 75% center;">

            <div class="absolute inset-0 bg-slate-950/20 z-10 backdrop-blur-[0.5px]"></div>

            <div class="absolute z-20 flex flex-col text-white text-left w-full max-w-2xl px-8" style="bottom: 7%; left: 3%;">
        ...
        <div class="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
            ...
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-5xl font-bold text-[#020617] mb-2">
                        Masuk
                    </h2>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-pink-600 text-sm font-medium">
                            Lupa kata sandi?
                        </a>
                    </div>
