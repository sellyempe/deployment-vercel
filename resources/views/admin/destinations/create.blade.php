    ...
    <form method="POST" action="{{ route('admin.destinations.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="space-y-5">
                ...
                <div class="bg-gray-900 border border-white/5 rounded-2xl p-6">
                    <h3 class="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-4">Galeri Destinasi <span class="text-pink-500">*</span></h3>
                    <div id="imagesDropArea"
                        ...
                        <div id="imagesPlaceholder">
                            <div class="w-16 h-16 bg-gray-800 rounded-2xl flex items-center justify-center mx-auto mb-4 text-3xl">🖼</div>
                    ...
                    <input type="file" id="imagesInput" name="images[]" accept="image/*" class="hidden" multiple required onchange="previewMultipleImages(this)">
