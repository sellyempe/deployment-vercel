        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-5">
                <a href="{{ route('profile') }}"
                    class="w-10 h-10 rounded-full bg-white border border-gray-100 flex items-center justify-center text-gray-600 hover:text-pink-500 shadow-sm transition-all hover:-translate-x-1">
            ...
            <div class="bg-white rounded-[32px] border border-gray-100 shadow-sm p-6">
                @if(session('success'))
                <div
                    class="mb-6 flex items-center gap-3 px-5 py-4 bg-emerald-50 border border-emerald-100 rounded-[20px] text-emerald-600 shadow-sm animate-in fade-in slide-in-from-top-4 duration-300">
                ...
                <div class="grid lg:grid-cols-[280px_1fr] gap-6">
                    <div>
                        <div class="relative overflow-hidden rounded-[20px] h-[420px]">
                            @if($user->photo)
                            <img id="previewImage" src="{{ format_image_url($user->photo) }}?t={{ time() }}"
                                alt="Profile" class="w-full h-full object-cover">
                            @else
                            <img id="previewImage" src="{{ asset('images/default-profile.png') }}" alt="Profile"
                                class="w-full h-full object-cover hidden">
                            <div id="emptyProfile"
                                class="w-full h-full bg-gradient-to-b from-pink-50 to-pink-100 flex flex-col items-center justify-center text-center px-6">
                                <div
                                    class="w-28 h-28 rounded-full bg-pink-500 text-white flex items-center justify-center text-5xl font-bold">
                    ...
                    <div class="min-w-0">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-3">
                                <div
                                    class="grid md:grid-cols-[150px_1fr] items-center gap-3 border-b border-gray-100 pb-2">
                                    <label class="font-semibold text-[#132440] text-xs">Nama Lengkap</label>
                                    <input name="name" type="text" value="{{ old('name', $user->name) }}"
                                        class="w-full h-[38px] rounded-lg border border-gray-200 px-3 outline-none focus:border-pink-500 text-sm">
                                </div>
                                ...
                                <div
                                    ...
                                    <input name="phone" type="tel" value="{{ old('phone', $user->phone ?? '') }}"
                                        ...
                                        oninvalid="this.setCustomValidity('Nomor telepon hanya boleh berisi angka (10-13 digit).')"
                                ...
                                <div class="grid md:grid-cols-[150px_1fr] items-center gap-3">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <label for="photoInput"
                                            class="bg-pink-500 hover:bg-pink-600 text-white px-4 py-1.5 rounded-lg font-semibold text-xs cursor-pointer transition">Pilih
                                            Foto</label>
                                ...
                                <div class="flex justify-end gap-3 pt-3 mt-2">
                                    <a href="{{ route('profile') }}"
                                        class="px-7 py-3 rounded-xl border border-pink-400 text-pink-500 font-semibold hover:bg-pink-50 transition text-sm">Batal</a>
                                    <button type="submit"
                                        class="px-7 py-3 rounded-xl bg-pink-500 hover:bg-pink-600 text-white font-semibold shadow-md transition text-sm">Simpan
                                        Perubahan</button>
                                </div>
                            </div>
                        </form>
